...
int main() {
    ...
    // Use full path to lexicon
    string lexiconPath = "C:/Users/dell/Documents/VSCode Code/MiniGoogle-DSA/lexicon.json";
    
    cout << "Loading lexicon from: " << lexiconPath << endl;
    if (!builder.initialize(lexiconPath)) {
        cerr << "Failed to load lexicon!" << endl;
        return 1;
    }
    
    // Process files
    builder.processDirectory("C:/Users/dell/Documents/VSCode Code/MiniGoogle-DSA/Data/pmc_json/", 58950);
    
    builder.printStatistics();
    builder.saveToFile("C:/Users/dell/Documents/VSCode Code/MiniGoogle-DSA/Forward Index/forward_index_FULL.txt");
